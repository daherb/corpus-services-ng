...
public class ReportTest {
    ...
    public void setUp() {
        ...
        comprehensiveReport.addCorrect("Correct", new BasicTranscriptionData(), "Third correct with corpus data");
        comprehensiveReport.addMissing("Missing","First missing");
        comprehensiveReport.addMissing("Missing", new BasicTranscriptionData(), "Second missing with corpus data");
        ...
        comprehensiveReport.addNote("Note", new BasicTranscriptionData(), "Fourth note with corpus data");
        ...
        comprehensiveReport.addCritical("Critical",new BasicTranscriptionData(), "Fifth critical with corpus data");
        comprehensiveReport.addCritical("Critical at the root");
        comprehensiveReport.addWarning("Warning", "First warning");
        comprehensiveReport.addWarning("Warning", new BasicTranscriptionData(), "Second warning with corpus data");
        ...
        comprehensiveReport.addException("Exception", new RuntimeException("Somet exception here again"), new BasicTranscriptionData(), "Third exception with corpus data");
        comprehensiveReport.addException(new RuntimeException("Something went wrong at the root"), "Exception at the root");
        comprehensiveReport.addFix("Fix",new BasicTranscriptionData(), "Only fix");
